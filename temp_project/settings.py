"""
Django settings for temp_project test_service.
...
# Build paths inside the test_service like this: BASE_DIR / 'subdir'.
...
LOGIN_REDIRECT_URL = reverse_lazy('userapp:home')
